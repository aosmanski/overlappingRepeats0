...
def modRMhit(SW_score, perc_div, perc_del, perc_ins, query_sequence, q_begin, q_end, q_left, orient, matching_repeat, class_family, r_begin, r_end, r_left, ID):
...
#Special cases for CAT2
# def write_hit_i1():
    # "This function prints the hit_i1"
    # OUTPUT.write(
        # str(SW_score_i)         + "\t" +        "UNKNOWN"               + "\t" +
        # "UNKNOWN"               + "\t" +        "UNKNOWN"               + "\t" + 
        # str(query_sequence_i)   + "\t" +        str(q_begin_i1)         + "\t" + 
        # str(q_end_i1)           + "\t" +        "UNKNOWN"               + "\t" + 
        # str(orient_i)           + "\t" +        str(matching_repeat_i)  + "\t" +
        # str(class_family_i)     + "\t" +        "UNKNOWN"               + "\t" +
        # "UNKNOWN"               + "\t" +        "UNKNOWN"               + "\t" +
        # str(ID_i+"A")           + "\n"
    # )

# def write_hit_i2():
	# "This function prints the hit_i2"
	# OUTPUT.write(
		# str(SW_score_i)         + "\t" +        "UNKNOWN"               + "\t" +
        # "UNKNOWN"               + "\t" +        "UNKNOWN"               + "\t" +
        # str(query_sequence_i)   + "\t" +        str(q_begin_i2)         + "\t" +
        # str(q_end_i2)           + "\t" +        "UNKNOWN"               + "\t" +
        # str(orient_i)           + "\t" +        str(matching_repeat_i)  + "\t" +
        # str(class_family_i)     + "\t" +        "UNKNOWN"               + "\t" +
        # "UNKNOWN"               + "\t" +        "UNKNOWN"               + "\t" +
        # str(ID_i+"B")           + "\n"
...
for HIT in HIT_ARRAY:
	...
	if CAT1:
		...
		if length_q>1:
			output_string=modRMhit(SW_score, perc_div, perc_del, perc_ins, query_sequence, q_begin, q_end, q_left, orient, matching_repeat, class_family, r_begin, r_end, r_left, ID)
...
#				q_begin_i1, q_end_i1, q_left, orient, matching_repeat, class_family, r_begin, r_end, r_left, ID)
			...
			q_end_i2 = q_end_i
#			output_string=modRMhit(SW_score, perc_div, perc_del, perc_ins, query_sequence,
#				q_begin_i2, q_end_i2, q_left, orient, matching_repeat, class_family, r_begin, r_end, r_left, ID)
			...
			#print(str(SW_score) + " < " + (str(SW_score_i)) + "." + "Split " + (str(SW_score_i)))
...
#			write_hit_i2()
		...
		#	length_q_i1=q_end_i1-q_begin_i1+1
		#	length_q_i2=q_end_i2-q_begin_i2+1
		#
		#	if length_q_i1>5:
		#		write_hit_i()
		#	if length_q_i2>5:
	...
	#		print(str(SW_score) + " > " + (str(SW_score_i)) + ". Keep " + (str(SW_score_i))+ ".")
#			write_hit_i()
			output_string=modRMhit(SW_score_i, perc_div_i, perc_del_i, perc_ins_i, query_sequence_i, q_begin_i, q_end_i, q_left_i, orient_i, matching_repeat_i, class_family_i, r_begin_i, r_end_i, r_left_i, ID_i)
			OUTPUT.write(output_string)
